    ...
    >
      ...
      <Container className="about-container text-center">
        <div className="about-content">
          ...
          <p className="about-column ">
            Heavily influenced by the work of Radiohead, Jeff Buckley, Philip Glass and David Bowie, Unspecified
            Pictures is a journey that takes place in a fugacious highway, completely manufactured by both the listener
            and the artist as the record progresses. The chaotic harmonies and the falling piano of Intro (Beloved the
            One Who Sits Down) are the frail departure of this trip that seamlessly paints different states of mind and
            real-life experiences, fluidly combining Lynchian dreams and raw emotions like love, self-doubt and
            loneliness. It is entirely what the title suggests: a picture of a naked human soul, unspecified because
            it’s continually changing and evolving into something different, to a degree where it is sometimes not able
            to recognize what it was before.
          </p>
          <p className="about-column ">
            ...
            design serves the purpose of communicating something that in real life is often impossible to convey: the
            most sincere and unfiltered emotions that some of us struggle to even accept, to the point that they might
            be unable to voice them out loud.
          </p>
          <p className="about-column ">
            ...
            tough times, remembering them that it’s okay to feel lonely and stuck; even when there’s not even the will
            to go on. And even if that feeling never seems to go away, we still have each other; we can still walk
            together, simply accepting the fact that we may never figure it out.
          </p>
        </div>
      </Container>
      <Footer />
